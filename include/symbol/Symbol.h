...
public:
    ...
    static bool compare(TypeClass *a, TypeClass *b);
...
public:
    ...
    SYMBOL_FLOATING_CONSTANT, SYMBOL_STRING_LITERAL, SYMBOL_VAR, SYMBOL_PARAMVAR,
    SYMBOL_CLASSREFVAR, SYMBOL_CONSTANTVAR, SYMBOL_TEMPVAR, SYMBOL_CLASSMEMVAR, SYMBOL_LABEL};
